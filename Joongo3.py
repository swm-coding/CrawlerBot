...
with open(os.path.join(BASE_DIR, "startJoongo3.txt"), "r") as f:
...
with open(os.path.join(BASE_DIR, "log.txt"), "a+") as f:
    f.write("startJoongo3.py " + str(datetime.now()) + " " + articles + "\n")

path=BASE_DIR + "/chromedriver_mac"
print(path)
...
os.remove(os.path.join(BASE_DIR,  "startJoongo3.txt"))

with open(os.path.join(BASE_DIR, "startJoongo3.txt"), "w") as f:
    f.write(articles)
