...
with open(os.path.join(BASE_DIR, "startJoongo4.txt"), "r") as f:
...
with open(os.path.join(BASE_DIR, "log.txt"), "a+") as f:
    f.write("startJoongo4.py " + str(datetime.now()) + " " + articles + "\n")
...
with open(os.path.join(BASE_DIR, "startJoongo4.txt"), "w") as f:
    f.write(articles)
