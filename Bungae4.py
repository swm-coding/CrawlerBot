...
with open(os.path.join(BASE_DIR, "startBungae4.txt"), "r") as f:
...
os.remove(os.path.join(BASE_DIR,  "startBungae4.txt"))

with open(os.path.join(BASE_DIR, "startBungae4.txt"), "w") as f:
    f.write(articles)
